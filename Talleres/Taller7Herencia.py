...
print ("#"*6, "Punto 1", "#"*6)
Persona1 = Persona (17, "Paco", 9887686)
...
print ("#"*6, "Punto 2", "#"*6)
Doctor1 = Doctor (45, "Perez", 87878788, "Cardiologo")
...
print ("#"*6, "Punto 3", "#"*6)
Nutricionista1 = Nutricionista (25, "Felipe", 83387383783, "Universidad CES")
...
print ("#"*6, "Punto 4", "#"*6)
Abogado1 = Abogado (49, "Miguel", 456666, "Penal", "Universidad de Medellin")
Abogado1.Representar ("Mario", "asesinato")